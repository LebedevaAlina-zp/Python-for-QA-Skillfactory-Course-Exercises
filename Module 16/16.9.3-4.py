...
class Customer:
    ...
    def __str__(self):
        return f'{self.first_name} {self.last_name}. {self.city}. Balance: ${self.balance}.'

    def main_info(self):
        return f'{self.first_name} {self.last_name}. {self.city}.'

cust_1 = Customer('Alina', 'Lebedeva', 'Tbilisi', 20)
print(cust_1)

cust_2 = Customer('Harry', 'Potter', 'Little Whinging', 10)
cust_3 = Customer('Ron', 'Weasley', 'The Burrow', 3.5)
cust_4 = Customer('Hermione', 'Granger', 'London', 40)
cust_5 = Customer('Albus', 'Dumbledore', 'Hogwarts', 1000)
